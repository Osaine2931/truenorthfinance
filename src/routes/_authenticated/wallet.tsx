...
export const Route = createFileRoute("/_authenticated/wallet")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Your available balance, welcome bonus and lifetime returns.",
      },
    ],
  }),
    ...
    <div className="animate-fade-up space-y-6">
      ...
      <div className="glass-blue relative overflow-hidden rounded-2xl p-6 shadow-elevated">
        ...
        <div className="relative">
          ...
          <p className="mt-2 inline-flex items-center gap-1.5 rounded-full bg-white/15 px-3 py-1 text-xs text-white">
            ...
            {formatCurrency(w?.welcome_bonus, 0)} Welcome Bonus · separate balance, not
            withdrawable, not transferable, and not investable
          </p>
      ...
      <SectionCard title="How your balance works">
        <ul className="space-y-2 text-sm text-muted-foreground">
          <li>
            • Deposits are credited after the blockchain transaction is confirmed by our team.
          </li>
          <li>
            • Your welcome bonus is kept separate, cannot be withdrawn, transferred, or invested,
            and is only available as a promotional balance.
          </li>
